...
- Refreshes the visible macOS editor immediately when themes change, preserves the loaded viewport during recoloring, and restores framework-type and function-call highlighting across supported programming languages without splitting existing comments, strings, attributes, or declarations and without expanding work beyond the existing visible range.
...
### Hero Screenshot
- ![v0.5.6 hero screenshot](docs/images/iphone-themes-light-frame.png)
