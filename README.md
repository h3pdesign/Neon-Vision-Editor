...
<p align="center">
  <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases"><img alt="Latest Release" src="https://img.shields.io/badge/release-v1.2.1-0A84FF"></a>
...
> Next release target: **v1.2.2**
> Platform target: **macOS 26 (Tahoe)** compatible with **macOS Sequoia**
> Apple Silicon: tested / Intel: not tested
> Direct GitHub release: **v1.2.1** / App Store and TestFlight availability varies by platform and review status
> Last updated (README): **2026-08-03** for latest release **v1.2.1**

## What's New in v1.2.0 and v1.2.1

### Why Upgrade

- v1.2.1: Adds platform-optimized toolbar presets with compact symbols and consistent controls across macOS, iPadOS, and iOS.
- v1.2.1: Makes toolbar and project workflows easier to configure from settings, including standard, focused, developer, review, and complete presets.
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>v1.2.1 release docs current; v1.2.1 direct download current</td>
      </tr>
      <tr>
...
<p align="center">
  <img alt="All Downloads" src="https://img.shields.io/static/v1?label=All+Downloads&message=6259&color=0A84FF&style=for-the-badge">
  <img alt="v1.2.1 Downloads" src="https://img.shields.io/static/v1?label=v1.2.1&message=104&color=22C55E&style=for-the-badge">
</p>
...
<p align="center">
  <img alt="Unique cloners (14d)" src="https://img.shields.io/static/v1?label=Unique+cloners+%2814d%29&message=476&color=7C3AED&style=for-the-badge">
  <img alt="Unique visitors (14d)" src="https://img.shields.io/static/v1?label=Unique+visitors+%2814d%29&message=572&color=0EA5E9&style=for-the-badge">
</p>
<p align="center">
  <img alt="Clone snapshot (UTC)" src="https://img.shields.io/static/v1?label=Clone+snapshot+%28UTC%29&message=2026-08-03&color=334155&style=flat-square">
  <img alt="View snapshot (UTC)" src="https://img.shields.io/static/v1?label=View+snapshot+%28UTC%29&message=2026-08-03&color=334155&style=flat-square">
</p>
...
|---|---|---|---|---|---|
| **Stable** | macOS | Direct notarized builds and fastest stable updates | [GitHub Releases](https://github.com/h3pdesign/Neon-Vision-Editor/releases) | **v1.2.1** | Current direct download |
...
| **Beta** | iOS / iPadOS / macOS | Testing upcoming changes before stable | [TestFlight Invite](https://testflight.apple.com/join/YWB2fGAP) | **v1.2.1** | Early access builds for feedback; availability may vary by review state |
...
| Toolbar and workspace presets | ![Full](https://img.shields.io/badge/Full-22C55E?style=flat-square)<br><sub>Compact labels; standard, focused, developer, review, complete, custom</sub> | ![Compact](https://img.shields.io/badge/Compact-7C3AED?style=flat-square)<br><sub>Icon-first toolbar; compact preset controls</sub> | ![Full](https://img.shields.io/badge/Full-22C55E?style=flat-square)<br><sub>Compact labels and preset controls</sub> | ![Adaptive](https://img.shields.io/badge/Adaptive-0A84FF?style=flat-square)<br><sub>Spatial toolbar presentation</sub> | Presets are configured from Settings; labels and available controls adapt to space and input. |
| Tab closing | ![Full](https://img.shields.io/badge/Full-22C55E?style=flat-square)<br><sub>Close controls and confirmation</sub> | ![Compact](https://img.shields.io/badge/Compact-7C3AED?style=flat-square)<br><sub>Double-tap tab</sub> | ![Full](https://img.shields.io/badge/Full-22C55E?style=flat-square)<br><sub>Double-tap tab</sub> | ![Adaptive](https://img.shields.io/badge/Adaptive-0A84FF?style=flat-square)<br><sub>Spatial tab controls</sub> | Unsaved-change confirmation remains active on every platform. |
| Status-bar and navigation surface | ![Full](https://img.shields.io/badge/Full-22C55E?style=flat-square)<br><sub>macOS window chrome</sub> | ![Full](https://img.shields.io/badge/Full-22C55E?style=flat-square)<br><sub>Transparent iOS composition</sub> | ![Full](https://img.shields.io/badge/Full-22C55E?style=flat-square)<br><sub>iPadOS surface composition</sub> | ![Adaptive](https://img.shields.io/badge/Adaptive-0A84FF?style=flat-square)<br><sub>Spatial chrome</sub> | v1.2.1 restores the transparent iOS status-bar composition without changing the editor or preview layout. |
...
| Git review | ![Full](https://img.shields.io/badge/Full-22C55E?style=flat-square)<br><sub>Local repository history, changes, and diffs</sub> | -- | -- | -- | Requires a local Git repository and an installed Git executable on macOS. |
| PTY Terminal and Python workflow | ![macOS only](https://img.shields.io/badge/direct_macOS_only-6B7280?style=flat-square)<br><sub>PTY terminal, Python project runner, and `nve` helper</sub> | -- | -- | -- | Available in the direct GitHub macOS build; intentionally omitted from App Store macOS builds and all mobile/spatial builds. |
...
|---|---|---|
| Stable direct download | `v1.2.1` notarized GitHub release | Current |
...
<p align="center">
  <img alt="Now" src="https://img.shields.io/badge/NOW-v1.2.1-22C55E?style=for-the-badge">
  <img alt="Next" src="https://img.shields.io/badge/NEXT-v1.2.2-F59E0B?style=for-the-badge">
  <img alt="Later" src="https://img.shields.io/badge/LATER-v0.8%2B-0A84FF?style=for-the-badge">
</p>

### Now (v1.2.1)

- ![v1.2.1](https://img.shields.io/badge/v1.2.1-22C55E?style=flat-square) focuses on editor interaction polish, Markdown preview stability, local custom AI endpoints, sidebar terminal improvements, and release workflow hardening.
  Tracking: [Release v1.2.1](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.2.1)

### Next (v1.2.2)

- ![v1.2.2](https://img.shields.io/badge/v1.2.2-F59E0B?style=flat-square) targets post-1.2.1 stabilization: App Store review follow-up, README/release metadata freshness, preview polish, and small cross-platform editor fixes.
...
Latest stable: **v1.2.1** (2026-08-02)
...
|---|---|---|
| [`v1.2.1`](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.2.1) | **Release highlights** — Adds platform-optimized toolbar presets with compact symbols and consistent controls across macOS, iPadOS, and iOS. | Removes the verbose “Toolbar Preset” label from the compact toolbar surface without removing its accessibility label or help text. |
| [`v1.2.0`](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.2.0) | **A more deliberate workflow** — Keeps the editor responsive while projects with large PDF and PNG collections are indexed. | Moves PDF card metadata and artwork work off the main actor with bounded background concurrency. |
| [`v1.1.1`](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v1.1.1) | **A more deliberate workflow** — Keeps the Markdown project card overview stable until a Markdown file is actually saved or changed on disk. | Stops unrelated project-folder events from rebuilding every Markdown preview card. |

- Full release history: [`CHANGELOG.md`](CHANGELOG.md)
- Latest release: **v1.2.1**
- Compare recent changes: [v1.2.0...v1.2.1](https://github.com/h3pdesign/Neon-Vision-Editor/compare/v1.2.0...v1.2.1)
