...
<p align="center">
  <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases"><img alt="Latest Release" src="https://img.shields.io/badge/release-v0.9.7-0A84FF"></a>
...
> Last updated (README): **2026-07-25** for latest release **v0.9.7**
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>v0.9.7 release docs current; v0.9.7 direct download current</td>
      </tr>
      <tr>
...
<p align="center">
  <img alt="All Downloads" src="https://img.shields.io/static/v1?label=All+Downloads&message=4970&color=0A84FF&style=for-the-badge">
  <img alt="v0.9.7 Downloads" src="https://img.shields.io/static/v1?label=v0.9.7&message=118&color=22C55E&style=for-the-badge">
</p>
...
<p align="center">
  <img alt="Now" src="https://img.shields.io/badge/NOW-v0.9.7-22C55E?style=for-the-badge">
  <img alt="Next" src="https://img.shields.io/badge/NEXT-v0.9.8-F59E0B?style=for-the-badge">
  <img alt="Later" src="https://img.shields.io/badge/LATER-v0.8%2B-0A84FF?style=for-the-badge">
</p>

### Now (v0.9.7)

- ![v0.9.7](https://img.shields.io/badge/v0.9.7-22C55E?style=flat-square) focuses on editor interaction polish, Markdown preview stability, local custom AI endpoints, sidebar terminal improvements, and release workflow hardening.
  Tracking: [Release v0.9.7](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v0.9.7)

### Next (v0.9.8)

- ![v0.9.8](https://img.shields.io/badge/v0.9.8-F59E0B?style=flat-square) targets post-0.9.7 stabilization: App Store review follow-up, README/release metadata freshness, preview polish, and small cross-platform editor fixes.
