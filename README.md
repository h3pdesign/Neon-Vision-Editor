...
> Direct GitHub release: **v0.8.4** / iOS App Store approved: **v0.7.8** / iOS App Store review pending: **v0.8.3** / macOS App Store approved: **v0.8.3** / macOS App Store review approved: **v0.8.3**
...
<p align="center">
  <img alt="All Downloads" src="https://img.shields.io/static/v1?label=All+Downloads&message=3380&color=0A84FF&style=for-the-badge">
  <img alt="v0.8.3 Downloads" src="https://img.shields.io/static/v1?label=v0.8.3&message=93&color=22C55E&style=for-the-badge">
</p>
...
<p align="center">
  ...
  <img alt="Unique visitors (14d)" src="https://img.shields.io/static/v1?label=Unique+visitors+%2814d%29&message=120&color=0EA5E9&style=for-the-badge">
</p>
<p align="center">
...
|---|---|---|---|---|---|
| **Stable** | macOS | Direct notarized builds and fastest stable updates | [GitHub Releases](https://github.com/h3pdesign/Neon-Vision-Editor/releases) | **v0.8.3** | Current direct download |
...
| **Store Review** | iOS / iPadOS | Upcoming App Store update | App Store Connect review | **v0.8.3** | In Apple review |
| **Store Review** | macOS | Upcoming App Store update | App Store Connect review | **v0.8.3** | No Pending Apple review |
| **Beta** | iOS / iPadOS / macOS | Testing upcoming changes before stable | [TestFlight Invite](https://testflight.apple.com/join/YWB2fGAP) | **v0.8.3** | Early access builds for feedback; availability may vary by review state |
