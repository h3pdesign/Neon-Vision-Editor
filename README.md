...
<p align="center">
  <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases"><img alt="Latest Release" src="https://img.shields.io/badge/release-v0.8.6-0A84FF"></a>
...
> Direct GitHub release: **v0.8.6** / iOS App Store approved: **v0.7.8** / iOS App Store review pending: **v0.8.4** / macOS App Store approved: **v0.7.8** / macOS App Store review pending: **v0.8.4**
> Last updated (README): **2026-07-10** for latest release **v0.8.6**

## What's New in v0.8.5 and v0.8.6
...
- v0.8.5: Fixes TestFlight crash reports tied to macOS window restoration callbacks and AppKit delegate forwarding during close/restore flows.
- v0.8.5: Restores reliable macOS editor text rendering after file load, sidebar toggles, window focus changes, and older macOS layout refreshes.
- v0.8.5: Expands TypeScript syntax highlighting so modern TypeScript files keep imports, decorators, utility types, async arrows, and property access readable.
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>v0.8.6 release docs current; v0.8.6 direct download current</td>
      </tr>
      <tr>
...
<p align="center">
  <img alt="All Downloads" src="https://img.shields.io/static/v1?label=All+Downloads&message=3469&color=0A84FF&style=for-the-badge">
  <img alt="v0.8.4 Downloads" src="https://img.shields.io/static/v1?label=v0.8.4&message=78&color=22C55E&style=for-the-badge">
</p>
...
<p align="center">
  <img alt="Unique cloners (14d)" src="https://img.shields.io/static/v1?label=Unique+cloners+%2814d%29&message=378&color=7C3AED&style=for-the-badge">
  <img alt="Unique visitors (14d)" src="https://img.shields.io/static/v1?label=Unique+visitors+%2814d%29&message=201&color=0EA5E9&style=for-the-badge">
</p>
<p align="center">
  <img alt="Clone snapshot (UTC)" src="https://img.shields.io/static/v1?label=Clone+snapshot+%28UTC%29&message=2026-07-08&color=334155&style=flat-square">
  <img alt="View snapshot (UTC)" src="https://img.shields.io/static/v1?label=View+snapshot+%28UTC%29&message=2026-07-08&color=334155&style=flat-square">
</p>
...
|---|---|---|---|---|---|
| **Stable** | macOS | Direct notarized builds and fastest stable updates | [GitHub Releases](https://github.com/h3pdesign/Neon-Vision-Editor/releases) | **v0.8.4** | Current direct download |
...
| **Store** | macOS | Apple-managed installs and updates | [Neon Vision Editor on the App Store](https://apps.apple.com/de/app/neon-vision-editor/id6758950965) | **v0.8.3** | Current public App Store listing |
| **Store Review** | iOS / iPadOS | Upcoming App Store update | App Store Connect review | **v0.8.4** | In Apple review |
| **Store Review** | macOS | Upcoming App Store update | App Store Connect review | **v0.8.4** | Pending Apple review |
| **Beta** | iOS / iPadOS / macOS | Testing upcoming changes before stable | [TestFlight Invite](https://testflight.apple.com/join/YWB2fGAP) | **v0.8.4** | Early access builds for feedback; availability may vary by review state |
...
|---|---|---|
| Stable direct download | `v0.8.6` notarized GitHub release | Current |
...
<p align="center">
  <img alt="Now" src="https://img.shields.io/badge/NOW-v0.8.6-22C55E?style=for-the-badge">
  <img alt="Next" src="https://img.shields.io/badge/NEXT-v0.8.7-F59E0B?style=for-the-badge">
  <img alt="Later" src="https://img.shields.io/badge/LATER-v0.8%2B-0A84FF?style=for-the-badge">
</p>

### Now (v0.8.6)

- ![v0.8.6](https://img.shields.io/badge/v0.8.6-22C55E?style=flat-square) focuses on editor interaction polish, Markdown preview stability, local custom AI endpoints, sidebar terminal improvements, and release workflow hardening.
  Tracking: [Release v0.8.6](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v0.8.6)

### Next (v0.8.7)

- ![v0.8.7](https://img.shields.io/badge/v0.8.7-F59E0B?style=flat-square) targets post-0.8.6 stabilization: App Store review follow-up, README/release metadata freshness, preview polish, and small cross-platform editor fixes.
...
Latest stable: **v0.8.6** (2026-07-10)

### Recent Releases (At a glance)

| Version | Date | Highlights | Fixes | Breaking changes | Migration |
|---|---|---|---|---|---|
| [`v0.8.6`](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v0.8.6) | 2026-07-10 | selectable recovery for unsaved drafts, document-scoped Markdown templates, and stronger release regression coverage | Brain Dump layout distortion by suppressing split panes and bracket helpers in its focused writing column; Swift 6 activity notification handling in the macOS text view; iPhone Markdown preview options so template, PDF mode, and copy/export actions remain reachable | None noted | None required |
...
| [`v0.8.4`](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v0.8.4) | 2026-07-06 | hover labels for toolbar buttons, improved find-panel typing focus and contrast, and expanded VIM normal-mode movement to physical arrow keys; Upgraded the macOS sidebar terminal from single-command execution to a persistent sidebar shell session for common git, npm, node, and docker-style commands; Serialized GitHub Pages deployments so fast successive pushes do not cancel or race active Pages publishes | custom AI provider validation so localhost endpoints can be used intentionally while public remote endpoints still require HTTPS; Coalesced Markdown preview reloads to reduce redundant refreshes during active typing and avoid avoidable WebView churn; Stabilized the sidebar terminal shell startup by avoiding interactive-shell assumptions in the pipe-backed implementation | None noted | None required |

- Full release history: [`CHANGELOG.md`](CHANGELOG.md)
- Latest release: **v0.8.6**
- Compare recent changes: [v0.8.5...v0.8.6](https://github.com/h3pdesign/Neon-Vision-Editor/compare/v0.8.5...v0.8.6)
