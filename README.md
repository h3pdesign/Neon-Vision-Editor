...
<p align="center">
  <a href="https://github.com/h3pdesign/Neon-Vision-Editor/releases"><img alt="Latest Release" src="https://img.shields.io/badge/release-v0.9.6-0A84FF"></a>
...
> Next release target: **v0.9.7**
> Platform target: **macOS 26 (Tahoe)** compatible with **macOS Sequoia**
> Apple Silicon: tested / Intel: not tested
> Direct GitHub release: **v0.9.6** / App Store and TestFlight availability varies by platform and review status
> Last updated (README): **2026-07-23** for latest release **v0.9.6**

## What's New in v0.9.5 and v0.9.6
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>v0.9.6 release docs current; v0.9.6 direct download current</td>
      </tr>
      <tr>
...
<p align="center">
  <img alt="All Downloads" src="https://img.shields.io/static/v1?label=All+Downloads&message=4673&color=0A84FF&style=for-the-badge">
  <img alt="v0.9.6 Downloads" src="https://img.shields.io/static/v1?label=v0.9.6&message=38&color=22C55E&style=for-the-badge">
</p>
...
<p align="center">
  <img alt="Unique cloners (14d)" src="https://img.shields.io/static/v1?label=Unique+cloners+%2814d%29&message=350&color=7C3AED&style=for-the-badge">
...
|---|---|---|---|---|---|
| **Stable** | macOS | Direct notarized builds and fastest stable updates | [GitHub Releases](https://github.com/h3pdesign/Neon-Vision-Editor/releases) | **v0.9.6** | Current direct download |
...
| **Beta** | iOS / iPadOS / macOS | Testing upcoming changes before stable | [TestFlight Invite](https://testflight.apple.com/join/YWB2fGAP) | **v0.9.6** | Early access builds for feedback; availability may vary by review state |
...
|---|---|---|
| Stable direct download | `v0.9.6` notarized GitHub release | Current |
...
<p align="center">
  <img alt="Now" src="https://img.shields.io/badge/NOW-v0.9.6-22C55E?style=for-the-badge">
  <img alt="Next" src="https://img.shields.io/badge/NEXT-v0.9.7-F59E0B?style=for-the-badge">
  <img alt="Later" src="https://img.shields.io/badge/LATER-v0.8%2B-0A84FF?style=for-the-badge">
</p>

### Now (v0.9.6)

- ![v0.9.6](https://img.shields.io/badge/v0.9.6-22C55E?style=flat-square) focuses on editor interaction polish, Markdown preview stability, local custom AI endpoints, sidebar terminal improvements, and release workflow hardening.
  Tracking: [Release v0.9.6](https://github.com/h3pdesign/Neon-Vision-Editor/releases/tag/v0.9.6)

### Next (v0.9.7)

- ![v0.9.7](https://img.shields.io/badge/v0.9.7-F59E0B?style=flat-square) targets post-0.9.6 stabilization: App Store review follow-up, README/release metadata freshness, preview polish, and small cross-platform editor fixes.
...
Latest stable: **v0.9.6** (2026-07-23)
...
- Latest release: **v0.9.6**
- Compare recent changes: [v0.9.5...v0.9.6](https://github.com/h3pdesign/Neon-Vision-Editor/compare/v0.9.5...v0.9.6)
