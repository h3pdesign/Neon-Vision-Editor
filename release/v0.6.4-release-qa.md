...
- Roadmap points `Next` to v0.6.4 quality work, not stale v0.6.3 diff items.
- The v0.6.4 milestone link points to milestone 16.
- The `What's New Since v0.6.2` section still reflects v0.6.3 release changes.
- App Store/TestFlight copy remains in `release/v0.6.3-store-copy.md` until a v0.6.4 release copy file is created.
